...
Seventy-three contracts are standalone TypeScript/Typia product contracts. The
...
also verifies all 104 shared operations, the API boundary rule, the 31 governed
runtime bridges, the 46 stable compatibility baselines, and 312 direct
spec-to-runtime graph edges.

If a normalized Zod boundary for one of the 31 bridge operations changes,
