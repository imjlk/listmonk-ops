...
these, 79 are `stable` and 25 are `experimental`. The runtime-operation
...
Seventy-nine reviewed core operations are `stable`: the existing
...
runtime bridges, the 79 stable compatibility baselines, and 317 direct
