      ...
      commands: [
        {
          ...
          options: {
            ...
            'check-links': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Check outbound links in campaign body', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":1332,"end":1337,"loc":{"start":{"line":41,"column":53,"index":1332},"end":{"line":41,"column":58,"index":1337}},"value":false}}]}, validator: '(val) => true' },
            'fail-on-warn': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Treat warnings as failures', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":1463,"end":1468,"loc":{"start":{"line":44,"column":54,"index":1463},"end":{"line":44,"column":59,"index":1468}},"value":false}}]}, validator: '(val) => true' }
          },
        ...
        },
        {
          ...
          options: {
            'campaign-id': { type: 'z.coerce.number.int.positive', required: true, hasDefault: false, description: 'Campaign ID', schema: {"type":"zod","method":"positive","args":[]}, validator: '(val) => true' },
            'bounce-threshold': { type: 'z.coerce.number.min.max.default', required: true, hasDefault: true, default: 0.05, description: 'Max allowed bounce rate', min: 0, max: 1, minLength: 0, maxLength: 1, schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":2534,"end":2538,"loc":{"start":{"line":83,"column":45,"index":2534},"end":{"line":83,"column":49,"index":2538}},"extra":{"rawValue":0.05,"raw":"0.05"},"value":0.05}}]}, validator: '(val) => true' },
            'open-threshold': { type: 'z.coerce.number.min.max.default', required: true, hasDefault: true, default: 0.08, description: 'Min required open rate', min: 0, max: 1, minLength: 0, maxLength: 1, schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":2684,"end":2688,"loc":{"start":{"line":89,"column":45,"index":2684},"end":{"line":89,"column":49,"index":2688}},"extra":{"rawValue":0.08,"raw":"0.08"},"value":0.08}}]}, validator: '(val) => true' },
            'click-threshold': { type: 'z.coerce.number.min.max.default', required: true, hasDefault: true, default: 0.01, description: 'Min required click rate', min: 0, max: 1, minLength: 0, maxLength: 1, schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":2834,"end":2838,"loc":{"start":{"line":95,"column":45,"index":2834},"end":{"line":95,"column":49,"index":2838}},"extra":{"rawValue":0.01,"raw":"0.01"},"value":0.01}}]}, validator: '(val) => true' },
            'pause-on-breach': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Pause running/scheduled campaign on breach', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":2966,"end":2971,"loc":{"start":{"line":100,"column":57,"index":2966},"end":{"line":100,"column":62,"index":2971}},"value":false}}]}, validator: '(val) => true' }
          },
          path: './src/commands/ops'
        },
        {
          ...
          options: {
            ...
            'inactivity-days': { type: 'z.coerce.number.int.positive.default', required: true, hasDefault: true, default: 90, description: 'Inactive threshold in days', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":3959,"end":3961,"loc":{"start":{"line":134,"column":48,"index":3959},"end":{"line":134,"column":50,"index":3961}},"extra":{"rawValue":90,"raw":"90"},"value":90}}]}, validator: '(val) => true' },
            ...
            'blocklist': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Blocklist sunset candidates', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":4387,"end":4392,"loc":{"start":{"line":148,"column":49,"index":4387},"end":{"line":148,"column":54,"index":4392}},"value":false}}]}, validator: '(val) => true' },
            'dry-run': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: true, description: 'Preview candidates without mutating subscribers', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":4503,"end":4507,"loc":{"start":{"line":151,"column":49,"index":4503},"end":{"line":151,"column":53,"index":4507}},"value":true}}]}, validator: '(val) => true' },
            'max-subscribers': { type: 'z.coerce.number.int.positive.default', required: true, hasDefault: true, default: 500, description: 'Max candidates to process in one run', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":4668,"end":4671,"loc":{"start":{"line":155,"column":48,"index":4668},"end":{"line":155,"column":51,"index":4671}},"extra":{"rawValue":500,"raw":"500"},"value":500}}]}, validator: '(val) => true' }
          },
          path: './src/commands/ops'
        },
        {
          ...
          options: {
            ...
            'threshold': { type: 'z.coerce.number.min.default', required: true, hasDefault: true, default: 0.2, description: 'Relative drift threshold (0.2 = 20%)', min: 0, minLength: 0, schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":5764,"end":5767,"loc":{"start":{"line":192,"column":55,"index":5764},"end":{"line":192,"column":58,"index":5767}},"extra":{"rawValue":0.2,"raw":"0.2"},"value":0.2}}]}, validator: '(val) => true' },
            'min-absolute-change': { type: 'z.coerce.number.int.min.default', required: true, hasDefault: true, default: 50, description: 'Minimum absolute subscriber delta for alert', min: 0, minLength: 0, schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":5917,"end":5919,"loc":{"start":{"line":196,"column":44,"index":5917},"end":{"line":196,"column":46,"index":5919}},"extra":{"rawValue":50,"raw":"50"},"value":50}}]}, validator: '(val) => true' },
            'lookback-days': { type: 'z.coerce.number.int.positive.default', required: true, hasDefault: true, default: 14, description: 'Baseline lookback window (days)', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":6087,"end":6089,"loc":{"start":{"line":202,"column":48,"index":6087},"end":{"line":202,"column":50,"index":6089}},"extra":{"rawValue":14,"raw":"14"},"value":14}}]}, validator: '(val) => true' }
          },
          path: './src/commands/ops'
        },
        {
        ...
        },
        {
          ...
          options: {
            'template-id': { type: 'z.coerce.number.int.positive', required: true, hasDefault: false, description: 'Template ID', schema: {"type":"zod","method":"positive","args":[]}, validator: '(val) => true' },
            'version-id': { type: 'z.string.trim.min', required: true, hasDefault: false, description: 'Stored version ID', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":8466,"end":8467,"loc":{"start":{"line":283,"column":47,"index":8466},"end":{"line":283,"column":48,"index":8467}},"extra":{"rawValue":1,"raw":"1"},"value":1}}]}, validator: '(val) => true' }
          },
          path: './src/commands/ops'
        },
        {
        ...
        },
        {
          ...
          options: {
            'hours': { type: 'z.coerce.number.int.positive.default', required: true, hasDefault: true, default: 24, description: 'Lookback window in hours', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":9658,"end":9660,"loc":{"start":{"line":326,"column":61,"index":9658},"end":{"line":326,"column":63,"index":9660}},"extra":{"rawValue":24,"raw":"24"},"value":24}}]}, validator: '(val) => true' },
            ...
            'markdown-only': { type: 'z.coerce.boolean.default', required: true, hasDefault: true, default: false, description: 'Print markdown only (no JSON envelope)', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":9895,"end":9900,"loc":{"start":{"line":332,"column":55,"index":9895},"end":{"line":332,"column":60,"index":9900}},"value":false}}]}, validator: '(val) => true' }
          },
          path: './src/commands/ops'
        }
      ],
