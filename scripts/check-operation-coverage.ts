...
export const operationCoverageContracts: readonly OperationCoverageContract[] = [
	...
	},
	{
		...
		testAnchor:
			"scripts/shared-operation-coverage.ts#assertMediaOperationsPublished:function",
		mcpHandler:
	...
	},
	{
		family: "maintenance",
		registry:
			"packages/operations/src/maintenance.ts#maintenanceOperations:variable",
		testAnchor:
			"scripts/shared-operation-coverage.ts#assertMaintenanceOperationsPublished:function",
		mcpHandler:
	...
	},
	{
		...
		registry:
			"packages/automation/src/webhook-operations.ts#webhookOperations:variable",
		testAnchor:
			"scripts/shared-operation-coverage.ts#assertWebhookOperationsPublished:function",
		mcpHandler:
			"packages/mcp/src/handlers/webhooks.ts#executeWebhookTools:function",
		dispatcher:
