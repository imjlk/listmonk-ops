...
HEAD_REF="${2:-}"
RELEASABLE_PATTERN='^(apps/cli/|packages/openapi/|packages/product-schema/|packages/operations/|packages/automation/|packages/common/|packages/abtest/|packages/mcp/)'
