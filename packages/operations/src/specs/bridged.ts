...
const bridgedOperationDeclarations = [
	...
	},
	{
		...
		effects: write("template", false, true),
		idempotent: true,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "reconcileTemplateManifestOperation",
		invoker: "invokeReconcileTemplateManifestOperation",
		executor: "executeTemplateManifestReconcile",
