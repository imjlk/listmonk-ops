...
const bridgedOperationDeclarations = [
	{
		...
		runtimeDefinition: "getListsOperation",
		invoker: "invokeGetListsOperation",
		executor: "listSubscriberLists",
		related: ["lists.get"],
	},
	{
		id: "lists.get",
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/lists.ts",
		runtimeDefinition: "getListOperation",
		invoker: "invokeGetListOperation",
		executor: "getSubscriberList",
	...
	},
	{
		...
		runtimeDefinition: "getSubscribersOperation",
		invoker: "invokeGetSubscribersOperation",
		executor: "listSubscribers",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/subscribers.ts",
		runtimeDefinition: "getSubscriberOperation",
		invoker: "invokeGetSubscriberOperation",
		executor: "getSubscriber",
		related: [
			"subscribers.update",
	...
	},
	{
		...
		runtimeDefinition: "getCampaignsOperation",
		invoker: "invokeGetCampaignsOperation",
		executor: "listCampaigns",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/campaigns.ts",
		runtimeDefinition: "getCampaignStatsOperation",
		invoker: "invokeGetCampaignStatsOperation",
		executor: "getCampaignStats",
		prerequisites: ["campaigns.get"],
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "getTemplatesOperation",
		invoker: "invokeGetTemplatesOperation",
		executor: "listTemplates",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "getTemplateOperation",
		invoker: "invokeGetTemplateOperation",
		executor: "getTemplate",
		related: [
			"templates.update",
	...
	},
	{
		...
		idempotent: false,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "createTemplateOperation",
		invoker: "invokeCreateTemplateOperation",
		executor: "createTemplate",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "updateTemplateOperation",
		invoker: "invokeUpdateTemplateOperation",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "deleteTemplateOperation",
		invoker: "invokeDeleteTemplateOperation",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/templates.ts",
		runtimeDefinition: "setDefaultTemplateOperation",
		invoker: "invokeSetDefaultTemplateOperation",
		executor: "setDefaultTemplate",
		prerequisites: ["templates.get"],
		verifyWith: ["templates.get"],
	},
	{
		...
		runtimeDefinition: "getMediaOperation",
		invoker: "invokeGetMediaOperation",
		executor: "listMedia",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/media.ts",
		runtimeDefinition: "getMediaFileOperation",
		invoker: "invokeGetMediaFileOperation",
		executor: "getMediaFile",
