...
const bridgedOperationDeclarations = [
	{
		...
		effects: write("list", true),
		idempotent: false,
		runtimeFile: "packages/operations/src/lists.ts",
		runtimeDefinition: "createListOperation",
		invoker: "invokeCreateListOperation",
		executor: "createSubscriberList",
	...
	},
	{
		...
		effects: write("list", false),
		idempotent: true,
		runtimeFile: "packages/operations/src/lists.ts",
		runtimeDefinition: "updateListOperation",
		invoker: "invokeUpdateListOperation",
		executor: "updateSubscriberList",
	...
	},
	{
		...
		idempotent: true,
		runtimeFile: "packages/operations/src/lists.ts",
		runtimeDefinition: "deleteListOperation",
		invoker: "invokeDeleteListOperation",
		executor: "deleteSubscriberList",
		prerequisites: ["lists.get"],
		verifyWith: ["lists.list"],
	},
	{
