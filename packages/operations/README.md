...
have standalone product-domain contracts. Eighty-six reviewed core operations
...
tag-reconciled A/B test creation, keyed list creation, keyed campaign creation,
and keyed template creation are stable mutations. The runtime-readiness
