...
have standalone product-domain contracts. Seventy-one reviewed core operations
...
manifest reconciliation, and exact-set webhook delivery pruning are stable
