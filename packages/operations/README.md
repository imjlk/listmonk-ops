...
Sixty-three contracts are authored as TypeScript types and projected with Typia.
...
types. Forty-two reviewed core operations are `stable`, including the first
