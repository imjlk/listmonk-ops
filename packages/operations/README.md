...
have standalone product-domain contracts. Eighty-five reviewed core operations
...
tag-reconciled A/B test creation, keyed list creation, and keyed
campaign creation are stable mutations. The runtime-readiness
