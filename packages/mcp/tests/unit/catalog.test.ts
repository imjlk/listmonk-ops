...
describe("operation catalog MCP adapter", () => {
	...
	test("keeps catalog output in parity at CLI and MCP boundaries", async () => {
		...
		expect(cliOutput.operations).toHaveLength(14);
