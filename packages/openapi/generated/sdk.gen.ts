 ...
 */
export const getImportSubscriberLogs = <ThrowOnError extends boolean = false>(options?: Options<GetImportSubscriberLogsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetImportSubscriberLogsResponses, unknown, ThrowOnError>({
...
export const createTemplate = <ThrowOnError extends boolean = false>(options: Options<CreateTemplateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateTemplateResponses, unknown, ThrowOnError>({
        url: '/templates',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * handles template modification.
 */
export const updateTemplateById2 = <ThrowOnError extends boolean = false>(options: Options<UpdateTemplateById2Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateTemplateById2Responses, unknown, ThrowOnError>({
