...
76개 계약은 독립적인 TypeScript/Typia 제품 계약입니다. 나머지 28개는
...
Operation 104개 전체, API 경계 규칙, 28개 governed runtime bridge, 46개
stable compatibility baseline과 spec-to-runtime 직접 graph edge 312개를
검증합니다.

28개 bridge Operation 중 하나의 정규화 Zod 경계가 바뀌면 workspace를
