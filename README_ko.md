...
104개 계약은 독립적인 TypeScript/Typia 제품 계약입니다. 이 중 86개는
...
검토를 마친 핵심 86개 Operation은 `stable`입니다. 기존
...
없어 생성 응답의 id가 바인딩에 필요). 현재 stable baseline은 86개이며,
나머지 experimental descriptor는 18개입니다.
...
Operation 104개 전체, API 경계 규칙, 0개 governed runtime bridge, 86개
