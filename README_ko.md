...
104개 계약은 독립적인 TypeScript/Typia 제품 계약입니다. 이 중 55개는
`stable`, 49개는 `experimental`이며 runtime-operation bridge는 비어 있습니다.
...
검토를 마친 핵심 55개 Operation은 `stable`입니다. 기존
...
현재 stable baseline은 55개이며, 나머지 experimental descriptor는 49개입니다.
