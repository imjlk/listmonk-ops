...
검토를 마친 핵심 87개 Operation은 `stable`입니다. 기존
...
파일명, 유효 MIME 타입, 표준형으로 정규화한 base64 내용에 대해 계산해
동등한 인코딩을 재생합니다. 현재 stable baseline은 87개이며, 나머지
experimental descriptor는 17개입니다.
...
Operation 104개 전체, API 경계 규칙, 0개 governed runtime bridge, 87개
