...
63개 계약은 독립적인 TypeScript/Typia 제품 계약입니다. 나머지 41개는
...
검토를 마친 핵심 42개 Operation은 `stable`입니다. 기존
...
`sequences.enrollments.get`도 새로 승격해 stable baseline을 36개에서 42개로
...
Operation 104개 전체, API 경계 규칙, 41개 governed runtime bridge, 42개
